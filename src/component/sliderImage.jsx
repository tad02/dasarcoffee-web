...
const Slideshow = () => {
  return (
    <div className="slide-container">
      ...
      <button className="nav default-nav" type="button" data-type="prev" aria-label="Previous Slide">
        <svg width="24" height="24" viewBox="0 0 24 24">
          <path d="M16.67 0l2.83 2.829-9.339 9.175 9.339 9.167-2.83 2.829-12.17-11.996z"></path>
        </svg>
      </button>
      <button className="nav default-nav" type="button" data-type="next" aria-label="Next Slide">
        <svg width="24" height="24" viewBox="0 0 24 24">
